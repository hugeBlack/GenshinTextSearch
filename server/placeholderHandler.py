...
if __name__ == "__main__":
    print(replace("#嗯，{NICKNAME}{M#他们}{F#她们}今天也会来参加庆祝活动。\n{PLAYERAVATAR#SEXPRO[INFO_MALE_PRONOUN_HE|INFO_FEMALE_PRONOUN_SHE]}是特别的，不需要神之眼也可以使用元素力。{REALNAME[ID(1)|HOSTONLY(true)]}", True, 1))